...
CAW and WGS %
run using \codeline{nextflow}~\cite{nextflow}.
%
...
%
The VM names are \codeline{knox$_i$} (resp.\ epouta$_i$) if it was
...
summing the different connections, we reached \texttt{941\ Mb/s} as
sender and \texttt{937\ Mb/s} as receiver. To compare, running the
same test between \texttt{knox2} and \texttt{knox1}, we get
\texttt{942\ Mb/s} as sender and \texttt{938\ Mb/s} as
receiver.
...
epouta1 \vmconnect\ knox1 & 275 Mb/s  & 272 Mb/s\\
epouta2 \vmconnect\ knox2 & 281 Mb/s  & 278 Mb/s\\
epouta3 \vmconnect\ knox3 & 452 Mb/s  & 447 Mb/s\\\hhline{=::=::=}
\multicolumn{1}{r||}{Total} & {\scriptsize 1008 Mb/s} & {\scriptsize 997 Mbits/s}\\\hhline{~||-||-}
\end{tabular}
\end{center}
