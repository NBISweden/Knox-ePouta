...
[ -n "$KE_DATA" ] || readonly KE_DATA=/home/fred/BioInfo/data
[ -n "$KE_SW" ]   || readonly KE_SW=/home/fred/BioInfo/sw

#################################################################
# Declaring the machines
declare -a KNOX_MACHINES
KNOX_MACHINES=('supernode' 'storage' 'knox1' 'knox2' 'knox3')
declare -a MACHINES
EPOUTA_MACHINES=('epouta1' 'epouta2' 'epouta3')
